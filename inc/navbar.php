    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/">
                <img src="http://<?php echo $_SERVER['SERVER_NAME']; ?>/images/logo.png" alt="Images">
                <span>CRID-DAM ROBOTIC LABS</span>
            </a>
        </div>
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/blog/index.php">Blog</a></li>
